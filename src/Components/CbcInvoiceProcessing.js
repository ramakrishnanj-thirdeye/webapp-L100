        ...
        <div className="container-fluid">
          <div className="card-body d-flex justify-content-center align-items-center p-0" style={{ position: "relative" }}>
            ...
            <iframe
              ...
              src="https://regale.cloud/thirdeye-data/play/3824/power-platform-accelerate-innovation-with-ai-in-low-code-supplier-portal-invoice#/0/0"
              title="Demo Frame"
...
export default CbcInvoiceProcessing;
