...
function CbcAbilitytoAskQuestions() {
        ...
        <div className="container-fluid">
          <div className="card-body d-flex justify-content-center align-items-center p-0" style={{ position: "relative" }}>
            ...
            <iframe
              ...
              src="https://regale.cloud/thirdeye-data/play/3834/power-platform-accelerate-innovation-with-ai-in-low-code-copilot-studio-maker#/0/0"
              title="Demo Frame"
...
export default CbcAbilitytoAskQuestions;
